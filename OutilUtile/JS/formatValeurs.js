...
<ul>
<li>Ce script permet de formater une colonne de valeur en une ligne de comme suit : 'valeur1', 'valeur2', 'valeur3'</li>
</ul>
`;
    ...
    <button type="button" id="reset" onclick="script3()">Reset</button><br><br>
